...
function Template4(props) {
  ...
  return (
    <div className="flex flex-col items-center ">
      ...
      <div className="relative top-3 left-3 items-center justify-center flex">
        <div
          className={`absolute lg:w-[1019px] w-[400px] h-[full]  border-8 border-pink-300  bg-white rounded-[36px] overflow-hidden top-[0px] flex`}
        >
          <div
          ...
          />
          <div className="h-[auto] lg:mt-full mt-[30px] lg:ml-[20px] text-center lg:text-left flex flex-col items-center my-8">
