        ...
        <div className="h-[auto] items-center justify-center">
            ...
            >
                    ...
                    <div className="bg-no-repeat bg-cover w-[55%] flex flex-col justify-between ">
                        ...
                        <div className="flex align-center items-center justify-center" onClick={setIsOpenPopup.bind(this, true)}>
                            <div>
                                < div
                ...
                {isOpenPopup && <CmtPopup setIsOpenPopup={setIsOpenPopup} data={data} TemplateCmt="TemplateCmt1" stt={props.stt}/>}
            </div>
        </div>
    );
}
