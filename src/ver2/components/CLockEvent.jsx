    ...
    return (
        <div className="flex flex-row">
            <div className="flex flex-col items-center">
                ...
                <span className="text-[23px] sharetech font-semibold text-white">Days</span>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="text-[23px] sharetech font-semibold text-white">Hours</span>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="text-[23px] sharetech font-semibold text-white">Minutes</span>
            </div>
            ...
            <div className="flex flex-col items-center">
                ...
                <span className="text-[23px] sharetech font-semibold text-white">Secs</span>
            </div>
        </div>
    );
}
